public class School {
         ...
         */
    static final String schoolName = "ASL COLLEGE";
    static final String adress = "London/ENGLAND";
    static final String telephone = "+10 123 234 34 45";
    static final String eMail = "aslCollege@edu";

    private School (){// we don't want to allow create any object from school class,
        // so we did this cons. private
    ...
    public static void printSchoolInformation() throws InterruptedException {
        ...
        System.out.println("============= ASL_COLLEGE =============\n" +
                "adress : "+adress+"\n"+
                "telephone : "+telephone+"\n"+
                "e mail : "+eMail);
        Thread.sleep(3000);
